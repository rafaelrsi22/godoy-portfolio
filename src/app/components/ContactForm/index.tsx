...
export default function ContactForm() {
  ...
  return (
    <form 
      action="" 
      className="max-w-[350px] md:min-w-[800px] z-30 flex flex-col gap-8"
    >
      ...
      <button
        className={`select-none px-4 py-1 w-fit m-auto rounded-full transition-all duration-500 ${isHovering ? 'bg-[#AA77E2]' : 'bg-none'} border-[#71717A] border`}
